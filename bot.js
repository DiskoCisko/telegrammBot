...
const initialMessage =  `Привет, друг!\n
Тут ты можешь вести список фильмов. 
Добавляй фильмы/сериалы, а когда не будешь знать, что посмотреть, вызови команду Случайный фильм 
и вот тебе уже есть под что скоротать вечерок. 
Удачи. 
`
const bot = new Telegraf(process.env.BOT_TOKEN)
bot.use(session())
bot.start((ctx) => {
    ctx.replyWithHTML(initialMessage, 
    getMainMenu()
    )
})
